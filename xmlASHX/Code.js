...
(function() {
    ...
    function onChanged() {
        ...
        var glenght = targetNode.getElementsByTagName("grade").length;
        txtOutput.innerHTML = targetNode.getElementsByTagName("name")[0].firstChild.nodeValue + "</br>";
        txtOutput.innerHTML += targetNode.getElementsByTagName("phone")[0].firstChild.nodeValue + "</br>";
        console.log(targetNode.getElementsByTagName("grades")[0].childElementCount);
        for (var x=0; x<glenght; x++ ){
            txtOutput.innerHTML += targetNode.getElementsByTagName("grade")[x].textContent + "</br>";
        } 
    }
